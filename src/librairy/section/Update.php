...
if($_SERVER["REQUEST_METHOD"]== "PUT")
{
    ...
    if(!empty($data->id) && !empty($data->domain) && !empty($data->length) && !empty($data->width))
    {
        $section->id = $data->id;
        ...
        if($section->update())
        {
           ...
           echo json_encode(array("message" => "La modification a été bien ajouté"))
        ...
        else
        {
            ...
            echo json_encode(array("message" => "La modification n'a pas été fait"));
        }
    }
}
else
